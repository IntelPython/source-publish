...
class TestWindowsConsoleControlHandler(BaseZMQTestCase):
    ...
    def test_handler(self):
        ...
        if os.name == 'nt':
            ...
            # Skip test; calling Ctrl-C from a subprocess prompts the user with the following:
            # "Terminate batch file (y/n):
            # This test breaks the testing mechanism if pytests is called from a subprocess.
            self.assertEqual("Oh Windows...", "Oh Windows...")
        else:
